      ...
      <v-card-text>
        <v-layout row class="my-3">
          ...
          <v-btn-toggle multiple v-model="periods">
            <v-btn flat v-for="item of periodItems" :key="item.value">
        ...
        <v-layout row>
          ...
          <v-select :items="instructorItems" v-model="instructors" multiple chips deletable-chips autocomplete
            hide-details></v-select>
        </v-layout>
        <v-divider></v-divider>
        <v-layout row class="mt-3">
          <label class="label body-2">Include classes that</label>
          <v-checkbox hide-details label="are full" v-model="full"></v-checkbox>
          <v-checkbox hide-details label="I've taken" v-model="taken"></v-checkbox>
          <v-checkbox hide-details label="are old" v-model="old"></v-checkbox>
          <v-spacer></v-spacer>
        </v-layout>
      </v-card-text>
    </v-card>
